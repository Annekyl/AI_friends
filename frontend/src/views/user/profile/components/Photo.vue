<script setup>
import { ref, watch, useTemplateRef, nextTick, onBeforeMount } from 'vue'
...
<template>
    <div class="flex justify-center">
        <div class="avatar relative">
            ...
            <div @click="fileInputRef.click()"
                class="absolute left-0 top-0 w-28 h-28 flex items-center justify-center bg-black/20 rounded-full cursor-pointer">
                <CameraIcon />
            </div>
        </div>
    </div>
    ...
    <dialog ref="modal-ref" class="modal" id="photo-modal">
