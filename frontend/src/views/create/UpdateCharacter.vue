...
const character_id = route.params.character_id
...
async function handleUpdate() {
    ...
    if (!photo) {
        ...
        if (backgroundImage !== character.value.background_image) {
            formData.append('background-image', base64ToFile(backgroundImage, 'background_image.png'))
        }
        try {
...
<template>
    <div v-if="character" class="flex justify-center mt-10">
