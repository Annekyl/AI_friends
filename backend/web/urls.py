...
from web.views.create.chacacter.get_list import GetListCharacterView
...
from web.views.friend.get_list import GetListView
...
urlpatterns = [
    ...
    path('api/friend/get_list/', GetListView.as_view()),
